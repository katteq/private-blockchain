...
class Blockchain {
  ...
  requestMessageOwnershipVerification(address) {
    return new Promise((resolve) => {
      resolve(`${address}:${getCurrentTimestamp().toString()}:starRegistry`)
    })
  }
  ...
  submitStar(address, message, signature, star) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const timelapse = (time - messageTime) / 60
      if (timelapse < 5) {
        ...
        reject('Timelapse is more than 5 minutes.')
      }
    })
  }
